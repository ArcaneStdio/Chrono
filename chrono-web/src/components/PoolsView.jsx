    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 px-3 py-2 bg-neutral-800/50 border border-neutral-700 rounded-lg text-sm">
            <span className="text-gray-400">Known assets only</span>
        ...
        <button className="px-6 py-2 bg-[#c5ff4a] hover:bg-[#b0e641] text-neutral-900 font-semibold rounded-lg transition-colors">
          Create Pool
        </button>
      </div>
        ...
        {isLoading ? (
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="flex items-center">
                  <div className="w-10 h-10 rounded-full bg-neutral-700 border-2 border-neutral-800 flex items-center justify-center text-lg">
                    $
                  </div>
                  <div className="w-10 h-10 rounded-full bg-neutral-700 border-2 border-neutral-800 flex items-center justify-center -ml-3 text-lg">
                    T
                  </div>
                </div>
                <div>
                  <div className="text-xs text-gray-500 mb-0.5">{pool.protocol}</div>
                  <div className="text-xl font-bold text-white">{pool.baseAsset} / {pool.quoteAsset}</div>
                </div>
              </div>
