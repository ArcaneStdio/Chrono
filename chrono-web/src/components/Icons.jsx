// DO NOT TOUCH OKAY THIS FILE(bvasically logic to convert emojis to cool icons)
...
export const CoinsIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const TrendDownIcon = ({ className = "w-5 h-5" }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
